...
function editorList() {
  const raw = process.env.EDITOR_EMAILS || process.env.TARGET_USER_UPN || '';
...
module.exports = { sign, verify, parseCookies, decodeIdTokenPayload, b64url, fromB64url, editorList, canEdit };
