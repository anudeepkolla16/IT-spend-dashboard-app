const { encodeGraphPath, sanitizeSegment, readJsonFile, writeJsonFile, uploadFileContent, graphFetch } = require('./graph');
...
module.exports = { runMailSync, appToSourceFolder, monthFolderName, sourceBase, planTrackerCells, planAmountCells, folderChildren, sumFolderInvoices, STATE_PATH, INDEX_PATH };
